...
const MainApp = ({ user }) => {
    ...
    const renderView = () => {
        switch (view) {
            ...
            default: // 'dashboard'
                return <Dashboard setView={setView} ideaPad={ideaPad} addJournalEntry={addJournalEntry} addIdea={addIdea} deleteIdea={deleteIdea} userId={user.uid} journal={journal} setDateFilter={setDateFilter} openAddJournalModal={() => setIsAddJournalModalOpen(true)} openAddIdeaModal={() => setIsAddIdeaModalOpen(true)} />;
        }
    };
