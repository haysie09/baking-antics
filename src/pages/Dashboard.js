                            ...
                            <div className="text-center bg-white p-4 rounded-xl mt-4">
                                ...
                                {(typeof idea.name === 'string' && !idea.name.includes("empty") && !idea.name.includes("used up")) && (
                                    <div className="flex flex-col justify-center items-center gap-3 mt-4">
                                        ...
                                        {inspiredBy === 'inspireMe' && <button onClick={handleAddToIdeaPad} className="w-full sm:w-auto bg-[var(--progress-card-bg)] text-[var(--progress-text)] py-1.5 px-4 rounded-full font-semibold hover:opacity-90 transition text-sm">Add to my Ideas</button>}
