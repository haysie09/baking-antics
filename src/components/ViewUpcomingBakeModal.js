        ...
        <Modal onClose={onClose} size="md">
            <div className="space-y-4 font-sans text-[#1b0d10]">
                <div className="flex justify-between items-start">
                    {/* UPDATED: Added "You plan to bake..." text and centered content */}
                ...
                <div className="flex justify-between items-center pt-4">
                    <div>
                        {/* If bake has an external link, show this icon */}
                        {bake.link && !bake.recipeId && (
                        ...
                        {/* If bake is from user's cookbook, show this button */}
                        {bake.recipeId && (
                     ...
                     <div className="flex items-center space-x-2">
                        {isPastOrToday ? (
                         ...
                         <button 
                            onClick={onClose} 
                            className="h-10 px-6 rounded-full bg-gray-800 text-white font-bold hover:bg-black text-sm"
                        >
                            Close
                        </button>
                    </div>
