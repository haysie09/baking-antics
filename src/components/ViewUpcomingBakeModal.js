...
// ICONS for buttons - It's cleaner to define them as components
...
const ViewUpcomingBakeModal = ({ bake, onEdit, onClose, onDelete, onMoveToJournal, onViewRecipe }) => {
    ...
    // This logic correctly determines if the bake is in the past and can be moved to the journal
    ...
    return (
        <Modal onClose={onClose} size="md" showFooter={false}>
            <div className="space-y-4 font-sans text-[#1b0d10]">
                ...
                {/* --- CHANGE 1: Displaying Personal Notes --- */}
                {/* Changed bake.notes to bake.personalNotes to show only user-added notes */}
                {bake.personalNotes && (
                ...
                {/* --- CHANGE 2: Refactored Button Layout --- */}
                <div className="flex justify-between items-center pt-6">
                    ...
                    <div className="flex items-center space-x-4">
                        {bake.link && (
                         ...
                         {/* This button now says "See Recipe" and correctly appears only for cookbook recipes */}
                        {bake.recipeId && (
                    ...
                    {/* Action buttons (Edit, Delete, Close) on the right */}
